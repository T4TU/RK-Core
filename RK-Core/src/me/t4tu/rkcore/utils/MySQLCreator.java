...
public class MySQLCreator {
	...
	private static final String[] queries = {
			...
			"CREATE TABLE player_stats (name varchar(16) NOT NULL, uuid varchar(40) NOT NULL, money int(11) NOT NULL DEFAULT '0', profession int(11) NOT NULL DEFAULT '0', profession_last_changed bigint(20) NOT NULL DEFAULT '0', visited_1 tinyint(1) NOT NULL DEFAULT '0', visited_2 tinyint(1) NOT NULL DEFAULT '0', visited_3 tinyint(1) NOT NULL DEFAULT '0', status varchar(256) NOT NULL DEFAULT '<Ei tilaviestiä>', friends text NOT NULL)", 
