...
public class MySQLCreator {
	...
	private static final String[] queries = {
			...
			"CREATE TABLE player_info (id int(11) NOT NULL, name varchar(16) NOT NULL, uuid varchar(40) NOT NULL, ip varchar(40) NOT NULL, chat_prefix varchar(40) NOT NULL DEFAULT '', chat_color varchar(16) NOT NULL DEFAULT '&7', chat_nick varchar(40) NOT NULL DEFAULT '', placeholder varchar(40) NOT NULL DEFAULT 'default', seconds bigint(20) NOT NULL DEFAULT '0', last_seen bigint(20) NOT NULL DEFAULT '0', nick_last_changed bigint(20) NOT NULL DEFAULT '0')", 
